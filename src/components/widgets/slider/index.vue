<template>
  ...
  >
    <SwiperSlide v-for="el in props.slides" :key="el.id">
      <div>
    ...
    <div class="swiper-button-prev" v-show="props.isPrevArrowVisible">
      <i class="fa fa-arrow-left arrow-size" aria-hidden="true"></i>
    </div>
    <div class="swiper-button-next" v-show="props.isNextArrowVisible">
