  ...
  <div class="col-lg-3 sidebar">
    <div class="sidebar-wrap bg-light">
      ...
      <form class="form">
        <div class="fields">
          ...
          <div class="form-group">
            <BaseButton text="Search" modifyStyle="btn-primary py-3 px-5" @click.prevent="search" />
          </div>
        </div>
      </form>
    </div>
    ...
    <div class="sidebar-wrap bg-light">
      ...
      <form class="star-rating">
        <div v-for="el in checkBoxConf" :key="el.id">
          <BaseCheckBox
            :type="el.type"
            :name="el.name"
            id="exampleCheck1"
...
function search() {
  ...
  hotelsStore.filterHotels(searchParams.value)
}
...
const searchParams = ref({
  ...
  maxPriceValue: 1000,
  starRating: {
    fiveStars: { checked: false, num: 5 },
    fourStars: { checked: false, num: 4 },
    threeStars: { checked: false, num: 3 },
    twoStars: { checked: false, num: 2 },
    oneStar: { checked: false, num: 1 },
  },
});
</script>
