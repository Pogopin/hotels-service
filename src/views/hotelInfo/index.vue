<template>
  <section class="ftco-section ftco-degree-bg">
    <div class="container">
              ...
              <div class="number__content" v-for="num in hotelInfo.numbers" :key="num.name">
                <div class="numbers__content-item item-content">
                  ...
                  <div class="item-content-price">
                    <span
                      >Цена: {{ num.price }}
                      <p>за ночь для 2 гостей</p></span
                    >
                  </div>
                </div>
                <p class="numbers__content-description">
                  {{ num.description }}
                </p>
      ...
      <Popup v-show="isPopupVisible">
        <SwiperSlider :isPrevArrowVisible="true" :isNextArrowVisible="true">
          <template #default>
            <SwiperSlide v-for="slide in inPopupSlides" :key="slide.photo">
              <div>
                <img :src="slide.photoImgUrl" alt="" />
              </div>
            </SwiperSlide>
